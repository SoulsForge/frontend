...
export const Route = createFileRoute("/_authenticated/create")({
  ...
  loader: async () => {
    const character: Partial<BaseCharacter> = {
      name: "",
      description: "",
      image_url: "",
      sliders: {
      ...
      <section className="mt-8 grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-0.5 gap-y-2 lg:flex lg:flex-wrap">
        ...
        <CharacterSection title="Face Template">
          ...
          <CharacterSubsectionEdit
            disabled={loading}
            title="Emphasis"
            value={getCurrentValue("sliders.face_template.emphasis", character)}
            onChange={(value) => {
        ...
        <CharacterSection title="Nose Ridge">
          ...
          <CharacterSubsectionEdit
            disabled={loading}
            title="Protrusion"
            value={getCurrentValue("sliders.nose_ridge.protrusion", character)}
            onChange={(value) => {
          ...
          <CharacterSubsectionEdit
            disabled={loading}
            title="Tip Height"
            value={getCurrentValue("sliders.nose_ridge.tip_height", character)}
            onChange={(value) => {
        ...
        <CharacterSection title="Tattoo/Mark/Eyepatch">
          ...
          <CharacterSubsectionEdit
            ...
            onChange={(value) => {
              updateState("sliders.tattoo_mark_eyepatch.eyepatch_color", value);
            }}
          />
        </CharacterSection>
        ...
        <CharacterSection title="Body">
          ...
          <CharacterSubsectionEdit
            ...
            title="Chest"
            value={
              partialState.sliders?.body?.chest || character.sliders.body.chest
            }
            onChange={(value) => {
